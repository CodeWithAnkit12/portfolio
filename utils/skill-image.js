...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'express js': return expressjs;
    ...
    /* -----------------------------
       Added mappings for your skills
       ----------------------------- */

    case 'sql': return mysql;
    case 'rest apis': return expressjs;
    case 'mvc': return nodejs;
    case 'modular architecture': return nodejs;
    case 'cosmosdb': return mongoDB;
    case 'query optimization': return postgresql;
    case 'ci/cd pipelines': return docker;
    case 'github actions': return git;
    case 'authentication': return nodejs;
    case 'authorization': return nodejs;
    case 'error handling': return javascript;
    case 'logging': return javascript;
    case 'vs code': return typescript;
    case 'nestjs': return nodejs;
    case 'postman': return graphql;
